					...
					<ul class="navbar-nav float-left mr-auto ml-3 pl-1">
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="#"> <i class='fas fa-child'></i>
									Registrar nuevo usuario <i class='fas fa-child'></i>
								</a>
							</div></li>
					</ul>
					<!-- ============================================================== -->
						...
						<li class="nav-item dropdown"><a
							...
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="ml-2 d-none d-lg-inline-block"><span>👋🏻,</span>
									<span class="text-dark"> Luis Herrera</span> <i
							...
							<div
								...
								<a class="dropdown-item" href="#"><i data-feather="power"
									class="svg-icon mr-2 ml-1"></i> Cerrar sesión </a>
			...
			<div class="page-breadcrumb">
				<div class="row">
					...
					<div class="col-5 align-self-center">
						<div class="customize-input float-right">Lunes 13 de Julio,
							2020</div>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid">
				...
				<footer class="footer text-center text-muted">
					...
					All Rights Reserved by Adminmart. Designed and Developed by <a
						href="https://wrappixel.com">WrapPixel- adaptado por Luis
						Herrera 👨🏻‍💻</a>.
				</footer>
				<!-- ============================================================== -->
				<!-- End footer -->
